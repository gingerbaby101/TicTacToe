...
public class TicTacToe {
    ...
    public static int iOfBest(ArrayList<Integer> list) {
        // TODO: Change this to just search and find a max. Much
        // better complexity as sorting takes O(n log(n)) and finding
        // a max only takes O(n)
